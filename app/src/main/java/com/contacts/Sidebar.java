...
public class Sidebar extends View {
    ...
    private void init(){
        ...
        paint.setTextSize(getResources().getDimensionPixelSize(UZResourcesIDFinder.getResDimenID("contacts_sider_bar_textsize")));
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:{
                if(header == null){
                    header = ((View)getParent()).findViewById(UZResourcesIDFinder.getResIdID("floating_header"));
                }
                setHeaderTextAndscroll(event);
                header.setVisibility(View.VISIBLE);
                setBackgroundResource(UZResourcesIDFinder.getResDrawableID("contacts_sidebar_background_pressed"));
                return true;
            }
